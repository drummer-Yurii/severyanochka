...
<template>
  <article class="product-card" @mouseover="isHovered = true" @mouseleave="isHovered = false">
    <div class="product-card__header header">
      ...
      <img class="product-card__image" :src="props.data.img" alt="" />
    </div>
    <div class="product-card__body">
      ...
      <Button v-else :color="'secondary'" :decoration="'default'" :count="props.data.count">
